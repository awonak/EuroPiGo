...
func DoInit() {
	...
	rev1.Initialize(rev1.InitializationParameters{
		...
		OutputVoltage1:         common.NewNonPicoPwm(rev1.HardwareIdCV1Output, cvCalMap),
		OutputVoltage2:         common.NewNonPicoPwm(rev1.HardwareIdCV2Output, cvCalMap),
		OutputVoltage3:         common.NewNonPicoPwm(rev1.HardwareIdCV3Output, cvCalMap),
		OutputVoltage4:         common.NewNonPicoPwm(rev1.HardwareIdCV4Output, cvCalMap),
		OutputVoltage5:         common.NewNonPicoPwm(rev1.HardwareIdCV5Output, cvCalMap),
		OutputVoltage6:         common.NewNonPicoPwm(rev1.HardwareIdCV6Output, cvCalMap),
